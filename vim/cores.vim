...
# hi Conceal          cterm=NONE   ctermbg=000  ctermfg=NONE gui=NONE   guibg=NONE    guifg=NONE
  ...
  hi CursorColumn     cterm=NONE   ctermbg=000  ctermfg=NONE gui=NONE   guibg=#000000 guifg=NONE
  hi CursorLine       cterm=NONE   ctermbg=000  ctermfg=NONE gui=NONE   guibg=#000000 guifg=NONE
  hi Directory        cterm=NONE   ctermbg=NONE ctermfg=NONE gui=NONE   guibg=NONE    guifg=NONE
  ...
  hi CursorLineFold   cterm=NONE   ctermbg=NONE ctermfg=NONE gui=NONE   guibg=NONE    guifg=NONE
  hi CursorLineSign   cterm=NONE   ctermbg=NONE ctermfg=NONE gui=NONE   guibg=NONE    guifg=NONE
  hi MatchParen       cterm=NONE   ctermbg=007  ctermfg=000  gui=NONE   guibg=#ffffff guifg=#000000
  hi MessageWindow    cterm=NONE   ctermbg=NONE ctermfg=NONE gui=NONE   guibg=NONE    guifg=NONE
  hi ModeMsg          cterm=NONE   ctermbg=NONE ctermfg=NONE gui=NONE   guibg=NONE    guifg=NONE
  hi MoreMsg          cterm=NONE   ctermbg=NONE ctermfg=NONE gui=NONE   guibg=NONE    guifg=NONE
  ...
  hi PmenuExtraSel    cterm=NONE   ctermbg=001  ctermfg=007  gui=NONE   guibg=#ff0000 guifg=#ffffff
  hi PmenuSbar        cterm=NONE   ctermbg=NONE ctermfg=NONE gui=NONE   guibg=NONE    guifg=NONE
  hi PmenuThumb       cterm=NONE   ctermbg=NONE ctermfg=NONE gui=NONE   guibg=NONE    guifg=NONE
...
# Syntax highlight groups
  ...
  hi Character        cterm=NONE   ctermbg=NONE ctermfg=011  gui=NONE   guibg=NONE    guifg=#ff3300
  hi Number           cterm=NONE   ctermbg=NONE ctermfg=011  gui=NONE   guibg=NONE    guifg=#ff3300
  hi Boolean          cterm=NONE   ctermbg=NONE ctermfg=011  gui=NONE   guibg=NONE    guifg=#ff3300
  hi Float            cterm=NONE   ctermbg=NONE ctermfg=011  gui=NONE   guibg=NONE    guifg=#ff3300

  hi Identifier       cterm=NONE   ctermbg=NONE ctermfg=007  gui=NONE   guibg=NONE    guifg=#ffffff
  hi Function         cterm=NONE   ctermbg=NONE ctermfg=006  gui=NONE   guibg=NONE    guifg=#01a3a3

  hi Statement        cterm=NONE   ctermbg=NONE ctermfg=011  gui=NONE   guibg=NONE    guifg=#ee9900
  hi Conditional      cterm=NONE   ctermbg=NONE ctermfg=011  gui=NONE   guibg=NONE    guifg=#ffbb00
  hi Repeat           cterm=NONE   ctermbg=NONE ctermfg=011  gui=NONE   guibg=NONE    guifg=#ffbb00
  hi Label            cterm=NONE   ctermbg=NONE ctermfg=011  gui=NONE   guibg=NONE    guifg=#cccc00
  hi Operator         cterm=NONE   ctermbg=NONE ctermfg=011  gui=NONE   guibg=NONE    guifg=#ee9900
  hi Keyword          cterm=NONE   ctermbg=NONE ctermfg=011  gui=NONE   guibg=NONE    guifg=#cccc00
  ...
  hi Tag              cterm=NONE   ctermbg=NONE ctermfg=011  gui=NONE   guibg=NONE    guifg=#ddbb00
...
#debugBreakpointDisabled xxx term=reverse ctermbg=248 guibg=gray
  ...
  hi Underlined    cterm=UNDERLINE ctermbg=NONE ctermfg=NONE gui=NONE   guibg=NONE    guifg=NONE
